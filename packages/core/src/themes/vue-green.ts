export const vueGreenTheme = `/*
 * ============================================
 * 主题名称：Vue 官方绿 (Vue Green)
 * 设计理念：复刻 Vue 官方文档风格，清新自然
 * ============================================
 */
...
#wemd h1 .content {
    ...
    font-weight: bold;
    color: #333;
    border-bottom: 3px solid #42b883; /* 底部绿色粗线条 */
    padding-bottom: 10px;
...
#wemd h3 .content {
    ...
    color: #333;
    padding-left: 10px;
    border-left: 4px solid #42b883; /* 左侧绿色竖线 */
}
...
#wemd hr {
    ...
    border: none;
    height: 1px;
    background-image: linear-gradient(to right, rgba(66, 184, 131, 0), rgba(66, 184, 131, 0.75), rgba(66, 184, 131, 0));
}
